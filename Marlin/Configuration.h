...
#define MY_PRINTER "ENDER 24.01.2021 #2"
#define MY_NAME "Alex B. 24.01.2021 #2"
...
#define STRING_CONFIG_H_AUTHOR MY_NAME // Who made the changes.
...
#define CUSTOM_MACHINE_NAME MY_PRINTER
